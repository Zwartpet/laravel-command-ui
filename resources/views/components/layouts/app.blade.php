...
<head>
    ...
    {{ Vite::useBuildDirectory('vendor/command-ui')->withEntryPoints(['resources/css/command-ui.css']) }}

    <title>{{ $title ?? __('command-ui::command-ui.website_title', ['app' => config('app.name')]) }}</title>
</head>
